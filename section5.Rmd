...
\begin{itemize}
\item Read the lab results from the file $\texttt{data/beer.csv}$.
...
\item Check this \href{https://www.guinness-storehouse.com/content/pdf/archive-factsheets/general-history/wsgosset-and-students-t-test.pdf}{link} 
