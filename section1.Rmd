...
* **S** programming language: created at Bell Labs (1975-1976). Before, statistical computing was mainly done by calling Fortran routines.
  * Richard A. Becker
...
* External to the R package:
  ...
  * [The Art of R Programming (Norman Matloff)](https://heather.cs.ucdavis.edu/~matloff/132/NSPpart.pdf)
...
*"Oefening baart kunst!" ("Exercise gives birth to art!" — Dutch proverb)*
...
## Install the `lobstr` package within R
