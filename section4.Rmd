...
subtitle: 'Section 4: Heterogeneous vectors (Lists & Dataframes) and IO'
...
* Return the $5$ first and the $10$ last entries in the data frame. $\newline$
* How many Ozone entries are missing? $\newline$
* Find the day and month where the max. temperature occurred $\newline$
* What is the average Ozone level for the days when the temperature >= 80?$\newline$
